...
There is a live, self-saving version of this list (progress persists in your browser):
the **eski Launch Checklist** artifact. This file is the versioned copy that build
sessions treat as the acceptance bar.
